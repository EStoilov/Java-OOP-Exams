...
public class VehicleAssembler implements Assembler {
    ...
    public double getTotalWeight() {
        return this.arsenalParts.stream()
                ...
                .sum()
                + this.shellParts.stream()
                .mapToDouble((x) -> x.getWeight())
                .sum()
                + this.enduranceParts.stream()
                .mapToDouble((x) -> x.getWeight())
                .sum();
    }
    ...
    public void addArsenalPart(Part arsenalPart) {
        this.arsenalParts
                .add((AttackModifyingPart)arsenalPart);
    }

    @Override
    public void addShellPart(Part shellPart) {
        this.shellParts
                .add((DefenseModifyingPart)shellPart);
    }

    @Override
    public void addEndurancePart(Part endurancePart) {
        this.enduranceParts
                .add((HitPointsModifyingPart)endurancePart);
    }
}