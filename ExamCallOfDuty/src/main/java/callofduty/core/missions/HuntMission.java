...
public class HuntMission extends BaseMission {
    ...
    protected void setRating(Double rating){
        super.setRating((rating * HUNT_MISSION_BOUNTY_PERCENTAGE_MODIFYING_INDEX) / GlobalConstants.TOTAL_PERCENTAGE_INDEX);
    }

    @Override
    protected void setBounty(Double bounty) {
        super.setBounty((bounty * HUNT_MISSION_BOUNTY_PERCENTAGE_MODIFYING_INDEX) / GlobalConstants.TOTAL_PERCENTAGE_INDEX);
    }
